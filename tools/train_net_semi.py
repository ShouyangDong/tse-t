...
from maskrcnn_benchmark.data import make_data_loader_semi
from maskrcnn_benchmark.solver import make_lr_scheduler
from maskrcnn_benchmark.solver import make_optimizer
from maskrcnn_benchmark.engine.inference import inference
from maskrcnn_benchmark.engine.trainer_semi import do_train
...
from semi_test.post_process import make_retinanet_semi_postprocessor
...
def create_model(cfg,ema=False):
...
def train(cfg, local_rank, distributed):
    ...
    arguments['postprocess'] = make_retinanet_semi_postprocessor(cfg, BoxCoder(weights=(10., 10., 5., 5.)), True)
...
def run_test(cfg, model, distributed):
    ...
    data_loaders_val = make_data_loader_semi(cfg, is_train=False, is_distributed=distributed)
