...
class COCODataset(torchvision.datasets.coco.CocoDetection):
    def __init__(
        self, ann_file, root, remove_images_without_annotations,temporal_saved_path, transforms=None
    ):
    ...
    def __getitem__(self, idx):
        ...
        with torch.no_grad():
            ...
            #with torch.no_grad():
            #bboxes = load_temporal_ens_id(img_infos['file_name'].replace('.jpg',''),self.temporal_saved_path,sel_threshold=0.05,ens_num=5)
