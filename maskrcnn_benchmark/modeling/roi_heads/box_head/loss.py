...
class FastRCNNLossComputation(object):
    ...
    def __call__(self, class_logits_spl, box_regression_spl):
        proposals = self._proposals
        device = class_logits_spl[0].device
        ...
        classification_loss = []
        box_loss = []
        for _class_logits, _box_regression,_proposal in zip(class_logits_spl,box_regression_spl,proposals):
