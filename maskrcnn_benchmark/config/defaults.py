...
# for semi supvervised ,provided transform  information
_C.INPUT.SEMI = True
...
#semi supervised
_C.SEMI = CN()
_C.SEMI.EMA_DECAY = 0.99
_C.SEMI.TEMPORAL_NUM = 10
_C.SEMI.TEMPORAL_SAVE_PATH = './'
_C.SEMI.FG_IOU_THRESHOLD = 0.7
_C.SEMI.BG_IOU_THRESHOLD = 0.3
_C.SEMI.SEMI_WEIGHT = 0.5
_C.SEMI.SEMI_STEP = -1
_C.SEMI.SEL_THR = 0.05
_C.SEMI.HYPER_PARAMETERS = CN()
_C.SEMI.HYPER_PARAMETERS.ENS_THRE = 0.15
_C.SEMI.HYPER_PARAMETERS.EPOCH_BATCH_NUM = 27210
_C.SEMI.HYPER_PARAMETERS.START_ITER = 3
_C.SEMI.HYPER_PARAMETERS.RAMPUP_LENGTH = 13
_C.SEMI.HYPER_PARAMETERS.MAX_CONSISTENT_LOSS = 0.08
_C.SEMI.HYPER_PARAMETERS.CONSISTENCE_WEIGHT = 0.5
_C.SEMI.HYPER_PARAMETERS.LABELED_DATABASE =  [0,]
_C.SEMI.HYPER_PARAMETERS.REG_CONSIST_WEIGHT =  20
_C.SEMI.HYPER_PARAMETERS.NCLS =  80
